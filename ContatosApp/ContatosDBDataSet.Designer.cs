...
namespace ContatosApp.ContatosDBDataSetTableAdapters {
...
SELECT ContactID, Name, Company, Telephone, Email, Client, LastCall FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ContatosApp.Properties.Settings.Default.ContatosDBConnectionString;
        }
        ...
        public virtual int Fill(ContatosDBDataSet.PeopleDataTable dataTable) {
        ...
        public virtual ContatosDBDataSet.PeopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContatosDBDataSet.PeopleDataTable dataTable = new ContatosDBDataSet.PeopleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContatosDBDataSet.PeopleDataTable dataTable) {
